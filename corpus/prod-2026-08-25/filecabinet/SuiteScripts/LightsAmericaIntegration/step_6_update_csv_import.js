 ...
 */
define(['N/config', 'N/https', 'N/log', 'N/record', 'N/render', 'N/runtime', 'N/search', 'N/url', 'N/https', 'N/encode', 'N/file', 'N/task'],
    /**
     * @param {config} config
     * @param {https} https
     * @param {log} log
     ...
     * @param {file} file
     */
    function (config, https, log, record, render, runtime, search, url, https, encode, file, task) {
        ...
        function map(context) {
            ...
            var fileLineCount = configRecord.getValue({
                fieldId: 'custrecord_update_file_line_count'
            });

            var fileProgressCount = configRecord.getValue({
                fieldId: 'custrecord_update_file_progress_count'
            });
            ...
            try {
                mrTask.scriptId = 'customscript_zastro_la_step_6';
        ...
        const csvCreator = (arraySet, peservedLineOne, processingFolderId) => {
            try {
                ...
                var fileObj = file.create({
                    ...
                    contents: buildCSV,
                    description: 'Lights America Update Integration File',
        ...
        const getResults = (configRecord) => {
            ...
            configRecord.setValue({
                ...
                fieldId: 'custrecord_update_file_process_status',
                value: 2 //In Progress
            });
            ...
            if (fileProgressCount >= fileLineCount) {
                ...
                configRecord.setValue({
                    ...
                    fieldId: 'custrecord_update_file_last_sync_date',
                    value: new Date()
                }).setValue({
                    fieldId: 'custrecord_update_file_process_status',
                    value: 3 //Done
